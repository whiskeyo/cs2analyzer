...
import { tutorialHubHref } from "@/lib/tutorial/query";
 ...
 * Replay + Aggregated before the `/tutorial` hub navigation.
 */
export function TutorialStart({ children }: Props) {
  return (
    <p className="home-faq-hint muted">
      Or{" "}
      <Link to={tutorialHubHref()} onPointerDown={() => warmupTutorialSession()}>
